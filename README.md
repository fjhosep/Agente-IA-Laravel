...
Obtener API Key: Consigue tu clave gratuita en Google AI Studio.
Configuración:
Abre el archivo security_agent_auditor.html.
Pega tu API Key en el campo superior.
Selecciona el modelo deseado (Gemini 3 Flash recomendado por velocidad).
Auditoría: Pega fragmentos de controladores, modelos o rutas de Laravel y el Agente generará un informe detallado en la terminal interactiva.
